...
import init_path
from act.utils import KaedeVideoWriter
...
def make_video(file_path):
    ...
    output_path = './tmp_videos'
    os.makedirs(output_path, exist_ok=True)
    
    video_name = file_path.split('/')[-1]
    video_name = video_name.replace('.hdf5', '')
  
    with h5py.File(file_path, 'r') as f:
        agentview_rgb = f['data']['demo_0']['obs']['agentview_rgb'][()]
        eye_in_hand_rgb = f['data']['demo_0']['obs']['eye_in_hand_rgb'][()]
        
        video_writer = KaedeVideoWriter(output_path, save_video=True, video_name=video_name+'_agentview.mp4', fps=30, single_video=True)
        for img in agentview_rgb:
            video_writer.append_image(img)
        video_writer.save()
        
        video_writer = KaedeVideoWriter(output_path, save_video=True, video_name=video_name+'_handview.mp4', fps=30, single_video=True)
        for img in eye_in_hand_rgb:
            video_writer.append_image(img)
        video_writer.save()
        

files = [
  '/home/zhaoyixiu/ISR_project/LIBERO/libero/datasets/libero_goal/open_the_middle_drawer_of_the_cabinet_demo.hdf5',
  '/home/zhaoyixiu/ISR_project/LIBERO/libero/datasets/libero_goal/open_the_top_drawer_and_put_the_bowl_inside_demo.hdf5',
  '/home/zhaoyixiu/ISR_project/LIBERO/libero/datasets/libero_goal/push_the_plate_to_the_front_of_the_stove_demo.hdf5',
  '/home/zhaoyixiu/ISR_project/LIBERO/libero/datasets/libero_goal/put_the_bowl_on_the_plate_demo.hdf5',
  '/home/zhaoyixiu/ISR_project/LIBERO/libero/datasets/libero_goal/put_the_bowl_on_the_stove_demo.hdf5',
  '/home/zhaoyixiu/ISR_project/LIBERO/libero/datasets/libero_goal/put_the_bowl_on_top_of_the_cabinet_demo.hdf5',
  '/home/zhaoyixiu/ISR_project/LIBERO/libero/datasets/libero_goal/put_the_cream_cheese_in_the_bowl_demo.hdf5',
  '/home/zhaoyixiu/ISR_project/LIBERO/libero/datasets/libero_goal/put_the_wine_bottle_on_the_rack_demo.hdf5',
  '/home/zhaoyixiu/ISR_project/LIBERO/libero/datasets/libero_goal/put_the_wine_bottle_on_top_of_the_cabinet_demo.hdf5',
  '/home/zhaoyixiu/ISR_project/LIBERO/libero/datasets/libero_goal/turn_on_the_stove_demo.hdf5'
]
